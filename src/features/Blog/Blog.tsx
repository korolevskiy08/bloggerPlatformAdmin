    ...
    <div className={styles.blogBlock}>
      <div className={styles.containerBlog}>
        <div className={style.titleBlock}>
          <p className={style.text} role="presentation" onClick={navigateBlogs}>
            Blogs
          </p>
          <img src={arrowRight} alt="arrowRight" />
          <h3 className={style.text}>{blog.name}</h3>
        </div>
        <div className={styles.backBlogs} role="presentation" onClick={navigateBlogs}>
          <img src={arrowLeft} alt="arrowLeft" />
          <p className={`text ${styles.backBlogsText}`}>Back to blogs</p>
        </div>
        ...
        <div className={styles.blog}>
          ...
          <div>
            ...
            <div className={styles.dateBlock}>
              <span className={`text ${styles.creationDataText}`}>
                creation date blog:
              </span>
              <span className={`text ${styles.creationData}`}>{blog.createdAt}</span>
            </div>
            <span className={`text ${styles.websiteText}`}>website: </span>
            <span className="text">
